...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-schema-registry" &&
                "${module_path}" != github.com/faustbrian/go-schema-registry/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-schema-registry"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
